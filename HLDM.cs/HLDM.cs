...
namespace WindowsGSM.Plugins
{
    public class HLDM
    {
        ...
        {
            name = "WindowsGSM.HLDM", // WindowsGSM.XXXX
            author = "GTVolk",
            description = "🧩 WindowsGSM plugin for supporting Half-Life: Deathmatch Dedicated Server",
            version = "1.0",
            url = "https://github.com/DevVault/WindowsGSM.HLDM", // Github repository link (Best practice)
            color = "#9eff99" // Color Hex
        };

        // - Standard Constructor and properties
		public HLDM(Functions.ServerConfig serverData) => this.serverData = serverData;
		
		// - Settings properties for SteamCMD installer
        public bool loginAnonymous => true;
        public string AppId => "70"; // Game server appId

        // - Game server Fixed variables
        public string StartPath => "hlds.exe"; // Game server start path
        public string FullName = "Half-Life: Deathmatch Dedicated Server"; // Game server FullName
        ...
        public string Game { get { return "valve"; } } // Default game name
        public string Defaultmap { get { return "crossfire"; } } // Default map name
